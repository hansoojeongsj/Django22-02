...
class TestView(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user_kim = User.objects.create_user(username="kim", password="tnwjd0919!")
        self.user_lee = User.objects.create_user(username="lee", password="tnwjd0919!")
        ...
        self.post003 = Post.objects.create(title="세번째 포스트", content="첫번째 포스트 입니다.",
                                       author=self.user_lee)
